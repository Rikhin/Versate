  ...
  return (
    <header className="sticky top-0 z-30 w-full bg-white/95 backdrop-blur border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-3 md:py-6 w-full flex items-center justify-between gap-4 md:gap-8">
        {/* Left: Logo group and user actions */}
        <div className="flex items-center flex-shrink-0 min-w-[180px] md:min-w-[320px] lg:min-w-[340px] justify-start gap-4 md:gap-6">
          ...
          {/* User actions/profile (now left of nav) */}
        ...
        {/* Center: Nav links */}
        <nav className="hidden md:flex flex-1 items-center justify-center gap-8 md:gap-12 text-base md:text-lg font-bold uppercase tracking-widest ml-2 md:ml-8 lg:ml-12">
