      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <section id="home" className="flex flex-col items-start justify-center min-h-[90vh] w-full relative pl-12 md:pl-24">
          ...
          <div ref={heroRef} className="relative z-10 flex flex-col items-start justify-center w-full parallax-hero-text">
            <h1 className="text-4xl md:text-6xl font-bold mb-4 text-left leading-[1.1] tracking-tight">
              Enhance Your High School<br />
              <span className="block mt-4 whitespace-nowrap">Experience with <span className="bg-gradient-to-r from-[#7b61ff] to-[#5ad1ff] bg-clip-text text-transparent">Versa</span></span>
            </h1>
