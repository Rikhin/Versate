      ...
      <div className="relative z-10 mx-auto" style={{maxWidth: '1200px', marginLeft: 'auto', marginRight: 'auto', paddingLeft: '24px', paddingRight: '24px'}}>
        ...
        <section id="works" className="container mx-auto px-4 md:px-8 py-8 md:py-20">
          <TextFade triggerStart="top 80%" triggerEnd="bottom 20%" stagger={0.15}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-16 justify-start text-left">
        ...
        <section id="about" className="container mx-auto px-4 md:px-8 py-8 md:py-20">
          <TextFade triggerStart="top 80%" triggerEnd="bottom 20%" stagger={0.1}>
            ...
            <div className="flex flex-col md:flex-row justify-start items-stretch gap-4 md:gap-8 text-left">
              {loadingProjects ? (
                ...
                featuredProjects.map((project, index) => (
                  <Card key={project.id || index} className="border-0 shadow-none bg-transparent flex-1 max-w-md">
                  <CardHeader className="pb-8 text-left">
                    <div className="flex justify-start items-start mb-4">
                      ...
                      <CardTitle className="text-xl font-medium text-black text-left">
                        {project.title && project.title.length > 32 ? project.title.slice(0, 32) + '…' : (project.title || 'Untitled Project')}
                      </CardTitle>
                    <CardDescription className="text-base text-gray-600 text-left">
        ...
        <section id="competitions" className="container mx-auto px-4 md:px-8 py-8 md:py-20">
          <TextFade triggerStart="top 80%" triggerEnd="bottom 20%" stagger={0.1}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 justify-start text-left">
