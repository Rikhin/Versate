...
const plans: Plan[] = [
  {
    ...
    oldPrice: null,
    priceId: null,
    description: "Access Versate's core features: search curated scholarships, competitions, summer programs, and mentors. Get started with personalized onboarding and basic AI matching.",
    features: [
      "Curated database: scholarships, competitions, summer programs, mentors",
      "Personalized onboarding questionnaire",
      "Basic AI-powered opportunity matching",
      "In-app messaging (limited)",
      "Save favorite opportunities",
      "Access to student community hub"
    ],
    cta: "Get Started",
  },
  {
    ...
    description: "Unlock advanced AI matching, full communication suite (in-app, external, AI email), and priority access to mentors and exclusive resources.",
    features: [
      "All Starter features",
      "Advanced AI-powered matching & recommendations",
      "Full communication suite: in-app, external email, AI-generated templates",
      "Priority access to mentors & counselors",
  ...
  },
  {
    ...
    description: "For power users: full access to Versate's ecosystem, custom integrations, API, automation tools, and exclusive community events.",
    features: [
      "All Plus features",
      "Custom integrations (Slack, Notion, etc.)",
      "API access & automation tools",
